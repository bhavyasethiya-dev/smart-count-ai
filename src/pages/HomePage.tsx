  ...
  const handleRunDetection = async () => {
    ...
    try {
      ...
      if (errorStr.includes('fetch')) {
        ...
        message = 'The AI engine is currently busy (Rate Limit). Please wait a moment before trying again.';
      } else if (errorStr.includes('404')) {
        message = 'Model Not Found: Please check your Gemini settings or API key permissions.';
